...
var QuestionTwo = React.createClass({
  ...
  handleYes: function() {
    firebaseUtil.tempSaveAssessQuest('question2', 1);
  },
  handleNo: function() {
    firebaseUtil.tempSaveAssessQuest('question2', 0);
  },
  render: function() {
    var style = {
      rootStyle: {
    ...
    return (
      <div id="assessContent">
        <div className="questionText">
          <h2>
            <span>Are you feeling down, depressed, or hopeless?</span>
          </h2>
        </div>
        <div className="bttn">
          <div className="yesBttn">
            <FlatButton
            linkButton={true}
            containerElement={<Link to='/assessment/question3'/>}
            label="YES" 
